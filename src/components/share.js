    ...
    <Fragment>
      ...
      <View style={{ alignItems: 'center', marginLeft: -20 }}>
        <View style={styles.shareWrapper}>
          ...
          <View style={{ width: '81%', position: 'relative', paddingRight: 10, paddingBottom: 10 }}>
            <Text style={styles.shareTitle}>Share with Friends</Text>
            <Text style={styles.shareDtl}>Share app to friends and make them fall in love with learning</Text>
