            ...
            >
              {({
                ...
                <View>
                  ...
                  <View style={{ position: "relative" }}>
                    <Text style={[globalStyle.inputLabel, { marginBottom: 5 }]}>
                      Mobile Number
                    </Text>
                  ...
                  <TouchableOpacity onPress={TermChange} style={styles.termBtn}>
                    ...
                    >
                      <View>
                        {term ? (
                          <Image style={styles.termImg} source={valid} />
                        ) : (
                          <Image style={styles.termImg} source={defaultImg} />
                        )}
                      </View>
                      <Text style={styles.termText_1}>
                        I agree to the{" "}
                        <Text style={styles.termText_2}>
